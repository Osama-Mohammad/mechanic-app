                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-{{ $serviceRequest->status == 'completed'
                                                    ? 'success'
                        ...
                        @if ($serviceRequest->payment)
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-{{ $serviceRequest->payment->status == 'paid' ? 'success' : 'warning' }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="status" name="status" required>
                                            <option value="pending"
                                                {{ $serviceRequest->status == 'pending' ? 'selected' : '' }}>Pending
                                            </option>
                                            <option value="accepted"
                                                {{ $serviceRequest->status == 'accepted' ? 'selected' : '' }}>Accepted
                                            </option>
                                            <option value="inprogress"
                                                {{ $serviceRequest->status == 'inprogress' ? 'selected' : '' }}>In Progress
                                            </option>
                                            <option value="completed"
                                                {{ $serviceRequest->status == 'completed' ? 'selected' : '' }}>Completed
                                            </option>
                                            <option value="canceled"
                                                {{ $serviceRequest->status == 'canceled' ? 'selected' : '' }}>Canceled
                                            </option>
                                            <option value="paid"
                                                {{ $serviceRequest->status == 'paid' ? 'selected' : '' }}>Paid</option>
                                        </select>
                                    </div>
                                </div>
                                {{-- <div class="text-end"> --}}
