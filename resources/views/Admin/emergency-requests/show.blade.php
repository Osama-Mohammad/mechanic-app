            ...
            <div class="card-body">
                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-{{ $emergencyRequest->status == 'completed'
                                                    ? 'success'
                ...
                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="status" name="status" required>
                                            <option value="pending"
                                                {{ $emergencyRequest->status == 'pending' ? 'selected' : '' }}>Pending
                                            </option>
                                            <option value="accepted"
                                                {{ $emergencyRequest->status == 'accepted' ? 'selected' : '' }}>Accepted
                                            </option>
                                            <option value="inprogress"
                                                {{ $emergencyRequest->status == 'inprogress' ? 'selected' : '' }}>In
                                                Progress</option>
                                            <option value="completed"
                                                {{ $emergencyRequest->status == 'completed' ? 'selected' : '' }}>Completed
                                            </option>
                                            <option value="canceled"
                                                {{ $emergencyRequest->status == 'canceled' ? 'selected' : '' }}>Canceled
                                            </option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-16">
                                <form action="{{ route('admin.emergency-requests.destroy', $emergencyRequest) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
